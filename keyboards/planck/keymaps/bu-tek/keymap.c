...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTZ] = LAYOUT_ortho_4x12(  
     RESCAPE,KC_Q   ,KC_W   ,KC_E   ,KC_R   ,KC_T   ,KC_Z   ,KC_U   ,KC_I   ,KC_O   ,KC_P   ,KC_LBRC,
     SYMBOL ,KC_A   ,KC_S   ,KC_D   ,KC_F   ,KC_G   ,KC_H   ,KC_J   ,KC_K   ,KC_L   ,KC_SCLN,KC_QUOT,
     KC_TAB ,KC_Y   ,KC_X   ,KC_C   ,KC_V   ,KC_B   ,KC_N   ,KC_M   ,KC_COMM,KC_DOT ,KC_MINS,KC_ENT ,
     KC_LCTL,KC_F3  ,RESCAPE,KC_F5  ,KC_LSFT,NAVBSPC,NAVSPC ,_______,_______,_______,_______,_______
  ),
  ...
  [_SYMBOL] = LAYOUT_ortho_4x12(
     ...
     _______,_______,_______,_______,KC_CAPS,_______,_______,KC_CAPS,_______,_______,_______,_______
  ),
