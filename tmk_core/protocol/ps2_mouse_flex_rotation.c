...
#    elif PS2_MOUSE_ROTATE == 270
    ...
    mouse_report->y = x;
#    else
    mouse_report->x = (cos(PS2_MOUSE_ROTATE*3.1416/180)*x - sin(PS2_MOUSE_ROTATE*3.1416/180)*y) * sqrtf(fabs(x) + fabs(y)) / 80;
    mouse_report->y = (sin(PS2_MOUSE_ROTATE*3.1416/180)*x + cos(PS2_MOUSE_ROTATE*3.1416/180)*y) * sqrtf(fabs(x) + fabs(y)) / 80;
#    endif
#endif
}
